...
rt = tk.Tk()
rt.geometry("700x400")
rt.minsize(700, 400) #ENABLE THIS ONCE DONE TESTING------------------------
...
#settings tab
bool_int_settings_lblframe = ttk.LabelFrame(settings_tab, text="intbool")
bool_int_settings_lblframe.grid(row=0, column=0, sticky="swen", columnspan=2, padx=5, pady=2)
str_int_settings_lblframe = ttk.LabelFrame(settings_tab, text="str")
...
settings_save_button = ttk.Button(settings_tab, text="Save", command=None, width=20)
settings_restore_button = ttk.Button(settings_tab, text="Restore", command=None, width=20)
...
tempcheck1 = ttk.Checkbutton(bool_int_settings_lblframe, text="make this a drop down menu and add ints", var=tempcheck1_state)
tempcheck1.pack()
...
temp_button_to_resize_to_default = ttk.Button(main_tab, text="default size - temp", command=lambda: rt.geometry("700x400"))
